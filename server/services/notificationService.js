    ...
    try {
        ...
        if (type === "deadline_approaching") {
            ...
            if (clientEmail) {
                ...
                if (server.io) {
                    server.io.to(clientEmail).emit("deadline_approaching", { title });
                }
            }
            ...
            if (providerEmail) {
                ...
                if (server.io) {
                    server.io.to(providerEmail).emit("deadline_approaching", { title });
                }
            }
        }
        ...
        if (type === "deadline_missed") {
            ...
            if (clientEmail) {
                ...
                if (server.io) {
                    server.io.to(clientEmail).emit("deadline_missed", { title });
                }
            }
            ...
            if (providerEmail) {
                ...
                if (server.io) {
                    server.io.to(providerEmail).emit("deadline_missed", { title });
                }
            }
        }
        ...
        if (type === "penalty_applied") {
            ...
            const newAmount = Number(extra?.newAmount || 0);
            ...
            if (violationType === "provider" && providerEmail) {
                ...
                if (server.io) {
                    server.io.to(providerEmail).emit("penalty_applied", {
                        title,
                        penaltyAmount
                    });
                }
            ...
            if (violationType === "client" && clientEmail) {
                ...
                if (server.io) {
                    server.io.to(clientEmail).emit("penalty_applied", {
                        title,
                        penaltyAmount
                    });
                }
